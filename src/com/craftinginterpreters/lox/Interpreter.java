...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>
{
    ...
    public Void visitClassStmt(Stmt.Class stmt)
    {
        ...
        LoxClass metaClass = new LoxClass(null, stmt.name.lexeme + " " +
            "metaclass", (LoxClass)superclass, classMethods);
    ...
    /**
     * Interpret calls to superclass methods when interpreting super.xxx()
     * @param expr The expression to interpret
     * @return The resulting object after calling the method
     */
    @Override
